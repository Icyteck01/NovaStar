...
$result .='	
  <tr id="transit_can_hide_'.$row['id'].'">
	...
	<a data-type="1" data-carid="'.$caridd.'" data-vak="'.$row['id'].'" data-vax="'.$row['cureentKM'].'" data-toggle="tooltip" title="'.$CFG["returnVehicule"].'" data-placement="bottom" class="btn btn-warning btn-xs flat remove_car_from_transit"><i class="fa fa-home"></i></a>
	</td>
	...
	<td data-toggle="tooltip" data-placement="bottom" title="'.$daydiff.' '.$CFG["DAY"].' & '.$hrsiff.' '.$CFG["HOUR"].' '.$CFG["AGO"].'">'.$rowx['since'].' </td>
  </tr>';
}
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li class="active">'.$CFG["CarManager_10"].'</li>
  </ol>
</section>
	...
	<div class="col-xs-12">
	  <div class="box box-danger">
		<div class="box-header">
		  <h3 class="box-title">'.$CFG["CarManager_11"].'</h3>
		</div><!-- /.box-header -->
		<div class="box-body">
